<div class="mx-4 my-8 grid grid-cols-1 gap-8 md:grid-cols-[30%_70%]">
			...
			<ul class="mt-2 ml-7 space-y-3">
				<li>
					...
					>
						...
						></span>
						<span class="group-hover:underline">Presupuesto Detallado</span>
					</a>
				</li>
				<li>
					<a
					...
					>
						<span
							class="mr-2 inline-block h-2 w-2 rounded-full bg-blue-500 group-hover:bg-indigo-600"
						></span>
						<span class="group-hover:underline">Acumulado ppto vs ejecutado</span>
					</a>
				</li>
			</ul>
				...
				<li>
					...
					>
						<span
							class="mr-2 inline-block h-2 w-2 rounded-full bg-blue-500 group-hover:bg-indigo-600"
						></span>
						<span class="group-hover:underline">Enero 2025</span>
					</a>
				</li>
				<li>
					<a
					...
					>
						<span
							class="mr-2 inline-block h-2 w-2 rounded-full bg-blue-500 group-hover:bg-indigo-600"
						></span>
						<span class="group-hover:underline">Febrero 2025</span>
					</a>
				</li>
				<li>
					<a
					...
					>
						<span
							class="mr-2 inline-block h-2 w-2 rounded-full bg-blue-500 group-hover:bg-indigo-600"
						></span>
						<span class="group-hover:underline">Parcial Marzo 2025</span>
					</a>
				</li>
			</ul>
		</ul>
	...
	<div class="rounded-xl border border-gray-100 bg-white p-8 shadow-lg md:mr-10">
		...
		<div class="px-2 md:px-6">
			<div class="container mx-auto p-4 md:p-8 text-sm md:text-xl">
				...
				<p class="mb-4 text-gray-700">
					...
					<p class="mb-4 text-gray-700">
						Nos dirigimos a ustedes con la mayor transparencia y preocupación para informarles sobre
						el estado actual de nuestro sistema de presión de agua y las acciones urgentes que hemos
						tenido que tomar.
					</p>

					<p class="mb-4 text-gray-700">
						Como saben, teníamos programado un mantenimiento preventivo de la motobomba, con un
						presupuesto inicial de $500.000. Sin embargo, al iniciar los trabajos, nos
						encontramos con una situación mucho más compleja de lo previsto. Debido a la antigüedad
						del sistema (más de 13 años en funcionamiento), la motobomba presentaba un deterioro
					...
					<p class="mb-4 text-gray-700">
						Estas reparaciones fueron esenciales, para garantizar el correcto funcionamiento de la bomba e
						implicaron un costo de 3.5 veces el presupuesto inicial ($1.711.726).
					</p>
					<p class="mb-4 text-gray-700">
						...
						están descontinuados, lo que nos obliga a reemplazar el tanque completo para restablecer
					...
					<ol class="mb-4 ml-6 list-inside list-decimal text-gray-700">
						<li>
							<span class="font-semibold">Recaudación de Fondos Extraordinaria:</span> Implementar una
							cuota extraordinaria para cubrir el costo del nuevo tanque. Esto nos permitiría restablecer
						...
						<li>
							...
							ordinarias. Esta opción, aunque permitiría evitar una cuota extraordinaria inmediata, prolongaría
							la situación actual de baja presión de agua en los apartamentos y podría afectar la ejecución
							de otras tareas de mantenimiento programadas para este año.
						</li>
					</ol>
					...
					<p class="mb-4 text-gray-700">
						Queremos asegurarles que hemos agotado todas las instancias posibles para minimizar los
						costos y buscar alternativas. Sin embargo, la situación actual del sistema, su
						antigüedad y la falta de repuestos nos obligan a tomar medidas urgentes para garantizar
						un servicio esencial como lo es el suministro de agua.
					</p>

					<h2 class="mt-6 mb-4 text-xl font-semibold text-red-500 md:text-2xl">Próximos Pasos:</h2>
